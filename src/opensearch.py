...
def get_opensearch_client() -> OpenSearch:
    """
    Initialize and returns an Opensearch client.

    Returns:
        Opensearch: Configure opensearch client.
    """
    client = OpenSearch(
...
def hybrid_search(
    ...
    """
    Performs a text-based and vector-based queries.
    ...
    logger.info(f"Hybrid search completed for query '{query_text}' with top k={top_k}.")
