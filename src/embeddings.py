...
def get_embedding_model() -> SentenceTransformer:
    """
    Loads and chashed emebeding model

    Returns:
        SentenceTransformer: The loaded embeding model 

    """
    logger.info(f"Loading embeding model from path: {EMBEDDING_MODEL_PATH}")
...
def generate_embeddings(chunks: List[str]) -> List[np.ndarray[Any, Any]]:
    ...
    Returns:
        List[np.adarray[Any, Any]]: List of embeddings.
    """
